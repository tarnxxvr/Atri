...
class Atri:
	def __init__(self, state: Any):
		...
		self.Navbar_flex = state["Navbar_flex"]
		self._setter_access_tracker = {}
	...
	@property
	def Navbar_flex(self):
		self._getter_access_tracker["Navbar_flex"] = {}
		return self._Navbar_flex
	@Navbar_flex.setter
	def Navbar_flex(self, new_state):
		self._setter_access_tracker["Navbar_flex"] = {}
		global default_state
		self._Navbar_flex = Flex(new_state, default_state["Navbar_flex"])

	def _to_json_fields(self):
		return {
			"Navbar_flex": self._Navbar_flex,
			}
